...
class VideoPostState extends ConsumerState<VideoPost>
  ...
  final VideoPlayerController _videoPlayerController =
      VideoPlayerController.asset("assets/videos/IMG_3987.MOV");
  ...
  void _onPlaybackConfigChanged() {
    if (!mounted) return;
    if (ref.read(playbackConfigProvier).muted) {
  ...
  void _onVisibilityChanged(VisibilityInfo info) {
    ...
    if (info.visibleFraction == 1 &&
      ...
      if (ref.read(playbackConfigProvier).autoplay) {
        _videoPlayerController.play();
      }
    }
  ...
  void _onCommentsTap(BuildContext context) async {
    ...
    await showModalBottomSheet(
      ...
      builder: (context) => VideoComments(), //Container()
    );
    // print('closed');
    _onTogglePause();
  }
      ...
      child: Stack(
        children: [
          ...
          Positioned(
            ...
            child: IconButton(
              icon: FaIcon(
                ref.watch(playbackConfigProvier).muted
              ...
              children: [
                ...
                GestureDetector(
                  ...
                  child: VideoButton(
                    ...
                    text: S.of(context).commentCount(545454545454545),
                  ),
                ),
                Gaps.v24,
